import{_ as sl,p as Qi,e as il,E as ol,g as al,d as Br,t as ul,l as Xi,f as ll,a as cl}from"./index-CWJX7hs9.js";var Yi={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */pe(Kf,Gf,"app");const Wf={apiKey:"",authDomain:"",projectId:"",storageBucket:"",messagingSenderId:"",appId:""},Hf=ta(Wf),um=Df(Hf),Qf={key:0,class:"ls"},Xf={class:"ls-bar"},Yf={__name:"LoadingScreen",props:{visible:{type:Boolean,default:!0},label:{type:String,default:"RoZter"},color:{type:String,default:"var(--c1)"}},setup(n){return(t,e)=>(Qi(),il(cl,{name:"fade"},{default:ol(()=>[n.visible?(Qi(),al("div",Qf,[Br("div",{class:"ls-logo",style:Xi({color:n.color})},ul(n.label),5),Br("div",Xf,[Br("div",{class:"ls-fill",style:Xi({background:n.color})},null,4)])])):ll("",!0)]),_:1}))}},lm=sl(Yf,[["__scopeId","data-v-4885b98b"]]);export{lm as L,im as a,sm as b,nm as c,um as d,bf as e,rm as f,om as o,am as s};
