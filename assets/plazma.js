...
(function () {
  ...
  function handleAccess() {
    ...
    if ((page === 'plazma-admin.html' || page === 'plazma-site-admin.html' || page === 'plazma-club.html' || page === 'plazma-stats.html') && !isAdmin()) { gate(deniedHtml('Cet espace est réservé aux administrateurs.')); return; }
